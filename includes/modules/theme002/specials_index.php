...
if ($num_products_count > 0) {
  ...
  while (!$specials_index->EOF) {
	...
	$products_butt2 = '<a class="btn products-button add-to-cart" href="' . zen_href_link(FILENAME_SPECIALS, zen_get_all_get_params(array('action')) . 'action=buy_now&products_id=' . $specials_index->fields["products_id"]) . '">' . zen_image_button(BUTTON_IMAGE_ADD_TO_CART, BUTTON_IN_CART_ALT) . '</a>';
    ...
    'text' => 
			...
			'<div class="product-col" data-match-height="spec_prod">
				<h5>' . $products_name . '</h5>
				<div class="img">
					' . $products_img . '
					<div class="price">
